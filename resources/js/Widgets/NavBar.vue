        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <Link class="nav-link hover" aria-current="page" :href="route('dashboard')">Profile</Link>
                    </li>
                    <li class="nav-item">
                ...
                <div class="d-flex"> 
                    ...
                    <div v-else>
                        ...
                        <Link class="ms-2" :href="route('dashboard')">
                            <img src="assets/Sound2.png" style="height: 2em;" class="rounded">
